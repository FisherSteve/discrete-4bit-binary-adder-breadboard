...
* [cite_start]**Hybrid-Design:** Bestehend aus einem Half Adder für das niederwertigste Bit (LSB) und drei Full Adder Stufen[cite: 1].
...
Die Schaltung wurde vorab in **CircuitVerse** simuliert. [cite_start]Sie besteht aus insgesamt 7 XOR-Gattern, 7 AND-Gattern und 3 OR-Gattern[cite: 1].
...
| **LEDs** | 5 | [cite_start]Anzeige für s0, s1, s2, s3 und c3 [cite: 1] |
